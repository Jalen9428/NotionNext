const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2026-08-03', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://laijalen.cn' }
  ],
  ...
  HEO_HERO_TITLE_3: 'LAIJALEN.CN',
  HEO_HERO_TITLE_4: '新版上线',
  HEO_HERO_TITLE_5: 'NotionNext4.0',
  HEO_HERO_TITLE_LINK: 'https://laijalen.cn',
  // 英雄区遮罩文字
  HEO_HERO_COVER_TITLE: '随便逛逛',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '计算机与信息学', url: '/category/计算机与信息学' },
  HEO_HERO_CATEGORY_2: { title: '游戏', url: '/category/游戏' },
  HEO_HERO_CATEGORY_3: { title: '日常', url: '/category/日常' },
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/Jalen9428',
